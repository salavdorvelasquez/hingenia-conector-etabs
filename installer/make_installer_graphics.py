...
def build():
    ...
    pres_path = os.path.join(assets, "espectra-presentation.png")
    pres.save(pres_path, "PNG")
    print("Generado:", pres_path)

    # 2. Banner lateral del wizard
    banner = create_wizard_banner()
    banner_path = os.path.join(assets, "espectra-wizard-banner.png")
    banner.save(banner_path, "PNG")
    print("Generado:", banner_path)

    # 3. Small image (esquina del wizard)
    small = create_wizard_small()
    small_path = os.path.join(assets, "espectra-wizard-small.png")
    small.save(small_path, "PNG")
    print("Generado:", small_path)
